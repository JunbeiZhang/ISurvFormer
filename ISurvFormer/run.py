...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='ISurvFormer/result', help="Result save directory")
    return parser.parse_args()

def main():
    args = parse_args()

    # Inject arguments into environment (or config)
    ...
    # === One-line entry: call your main logic
    import main  # 🔁 run logic inside main.py (must be modularized)
