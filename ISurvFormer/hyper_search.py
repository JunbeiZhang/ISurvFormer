...
def objective(trial, D,
              x_all, x_true_all, mask_raw_all, mask_train_all,
              time_all, mask_pad_all, lengths_all, duration_all, event_all):
    ...
    mean_cidx = train_model_cv(
        ...
        x_all=x_all, x_true_all=x_true_all,
        mask_raw_all=mask_raw_all, mask_train_all=mask_train_all,
